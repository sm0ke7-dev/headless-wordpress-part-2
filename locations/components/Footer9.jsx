        ...
        <div className="grid grid-cols-1 gap-x-[8vw] gap-y-12 border border-border-primary p-8 md:gap-y-16 md:p-12 lg:grid-cols-[0.75fr_1fr] lg:gap-y-4">
          <div className="flex flex-col">
            ...
            <p className="mb-5 md:mb-6">
              Get rehab insights and recovery tips delivered monthly.
            </p>
          ...
          <div className="grid grid-cols-1 items-start gap-y-10 sm:grid-cols-3 sm:gap-x-6 md:gap-x-8 md:gap-y-4">
            ...
            <div className="flex flex-col items-start justify-start">
              <h2 className="mb-3 font-semibold md:mb-4">San Jose</h2>
              <ul>
                <li className="py-2 text-sm">
                  <a href="#" className="flex items-center gap-3">
              ...
              <ul className="flex flex-col items-start">
                ...
                <li className="py-2 text-sm">
                  <a href="#" className="flex items-center gap-3">
                    ...
                    <span>
                      © 2025 Physio Pain Center. All rights reserved.
                    </span>
                  </a>
                </li>
              </ul>
