...
export function Testimonial22({ data }) {
  ...
  const description = data?.testimonials_description || "Patients who stuck with treatment";

  const defaultTestimonials = [
    {
      logo: { url: "https://d22po4pjz3o32e.cloudfront.net/webflow-logo.svg", alt: "Logo" },
      quote: "I stopped guessing about my knee and started measuring progress. Six weeks in, I was back to running.",
      avatar: { url: "https://d22po4pjz3o32e.cloudfront.net/placeholder-image.svg", alt: "Avatar" },
      name: "Marcus Chen",
      position: "Runner, San Jose",
      button_text: "Read case study"
    },
    {
      logo: { url: "https://d22po4pjz3o32e.cloudfront.net/webflow-logo.svg", alt: "Logo" },
      quote: "They found what was actually wrong instead of telling me to rest it out. I'm pain-free and stronger now.",
      avatar: { url: "https://d22po4pjz3o32e.cloudfront.net/placeholder-image.svg", alt: "Avatar" },
      name: "Sarah Mitchell",
      position: "Post-op patient, Sacramento",
      button_text: "Read case study"
    },
    {
      logo: { url: "https://d22po4pjz3o32e.cloudfront.net/webflow-logo.svg", alt: "Logo" },
      quote: "The plan made sense from day one. No mystery. Just clear steps and measurable wins each week.",
      avatar: { url: "https://d22po4pjz3o32e.cloudfront.net/placeholder-image.svg", alt: "Avatar" },
      name: "David Reeves",
      position: "Athlete, Long Beach",
      button_text: "Read case study"
    }
  ];
